        ...
        public static IEnumerable<Client> GetClients()
        {
            return new[]
            {
                new Client
                {
                    ...
                    PostLogoutRedirectUris = { "http://localhost:7200/auth/signout-callback" },
                ...
                new Client
                {
                    ...
                    PostLogoutRedirectUris = { "http://localhost:5000/auth/signout-callback" },
                ...
                new Client
                {
                    ...
                    ClientSecrets = { new Secret("your-client-secret".Sha512()) },
                    AllowOfflineAccess = true,
                    AllowedScopes = { "openid", "profile", "email", "offline_access" },
                    RedirectUris = { "http://app-127-0-0-1.nip.io/_oauth" },
                    // PostLogoutRedirectUris = {"http://localhost:5000/auth/signout-callback"},
                    AllowedCorsOrigins = { "http://app-127-0-0-1.nip.io" },
                    AccessTokenLifetime = (int)TimeSpan.FromMinutes(120).TotalSeconds
                }
            };
        }
